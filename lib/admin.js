...
export const admin = {
  ...
  transactions:       (q)   => req(`/admin/transactions?${new URLSearchParams(q)}`),
  opusProjects:       (q)   => req(`/admin/opus/projects?${new URLSearchParams(q)}`),
  deleteOpusProject:  (id)  => req(`/admin/opus/projects/${id}`, { method: 'DELETE' }),
