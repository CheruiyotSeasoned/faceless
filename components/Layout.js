...
export default function Layout({ children, title = 'CliptoKai', hideNav = false, minimal = false }) {
  return (
    <>
      <Head>
        <title>{title === 'CliptoKai' ? 'CliptoKai — AI Video Generator' : `${title} — CliptoKai`}</title>
